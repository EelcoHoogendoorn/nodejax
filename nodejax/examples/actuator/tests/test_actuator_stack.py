...
from nodejax.examples.actuator import (DQ, electrical_def, mechanical_def,
...
def build_env(command_ctrl=None, capacity=jnp.inf, model_tau=0.0,
    ...
    with ambient(dt=dt):
        ...
        cc = current_controller_def(
            ...
            bus_est=noisy_def(0.2) >> ema_def()(tau=1e-3),
