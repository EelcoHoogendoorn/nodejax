...
from nodejax.composite import _promote_members
from nodejax.contract import ContractCalls, _KEEP
from nodejax.definition import Captures, Def, Layout
from nodejax.frozendict import frozendict
from nodejax.node import _is_node, _view
...
class Wrapped:
    ...
    def __call__(self, apply=None, *, name=None, contract=None,
                 tags=None, boundary: Mapping = _EMPTY_MAPPING,
                 methods: Mapping = _EMPTY_MAPPING,
                 destructurable=True, destructurable_state=True,
                 rng_from=None):
        if apply is not None:
            ...
            from nodejax.compose import _wrap_build
            return _wrap_build(
