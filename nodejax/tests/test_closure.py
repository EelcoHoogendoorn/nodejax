...
from nodejax import NodeDef, batch, ensemble, stack, scan, train_step, nn
...
def test_train_step_of_stateful_pipe():
    ...
    assert jnp.any(final.inner.ema != 0.0)
