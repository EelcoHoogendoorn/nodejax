...
rather than for pytest, and the actuator package is library code beneath its
...
def _all_modules():
    """Every module in the package, tests included: importing a test module is
    as good a check as importing anything else."""
    for info in pkgutil.walk_packages(nodejax.__path__, prefix='nodejax.'):
        yield info.name
...
RUNNABLE = [
    ...
    'nodejax.examples.comparisons.lift.lift_nodejax',
    'nodejax.examples.comparisons.lift.lift_nnx',
    'nodejax.examples.comparisons.lift.lift_equinox',
    ...
    # blame it on.
    'nodejax.examples.comparisons.residual.residual_nodejax',
    'nodejax.examples.comparisons.residual.residual_nnx',
    'nodejax.examples.comparisons.residual.residual_equinox',
    'nodejax.examples.comparisons.chunk.chunk_nodejax',
    'nodejax.examples.comparisons.tower.tower_nodejax',
    'nodejax.examples.comparisons.ttt.ttt_nodejax',
    ...
    'nodejax.examples.comparisons.chunk.chunk_flax',
    'nodejax.examples.comparisons.chunk.chunk_flax_linen',
    'nodejax.examples.comparisons.chunk.chunk_equinox',
    'nodejax.examples.comparisons.chunk.chunk_haiku',
    'nodejax.examples.comparisons.chunk.chunk_torch',
    ...
    'nodejax.examples.comparisons.ttt.ttt_rnn_by_hand',
    'nodejax.examples.comparisons.ttt.ttt_equinox',
    'nodejax.examples.comparisons.ttt.ttt_haiku',
    'nodejax.examples.comparisons.ttt.ttt_rnn_flax',
    'nodejax.examples.comparisons.ttt.ttt_rnn_torch',
    # the tower rivals, same reasoning: each main() asserts its meta loss
    # fell, and nothing else ever runs them
    'nodejax.examples.comparisons.tower.tower_flax',
    'nodejax.examples.comparisons.tower.tower_flax_reusable',
    'nodejax.examples.comparisons.tower.tower_equinox',
    'nodejax.examples.comparisons.tower.tower_torch',
    'nodejax.examples.comparisons.tower.tower_keras',
    ...
    'nodejax.examples.comparisons.tie.tie_nodejax',
    'nodejax.examples.comparisons.tie.tie_equinox',
    'nodejax.examples.comparisons.tie.tie_flax',
    'nodejax.examples.comparisons.tie.tie_torch',
    'nodejax.examples.comparisons.tie.tie_haiku',
    # the mode family: train and eval as a property of the program
    'nodejax.examples.comparisons.mode.mode_nodejax',
    'nodejax.examples.comparisons.mode.mode_flax',
    'nodejax.examples.comparisons.mode.mode_equinox',
    'nodejax.examples.comparisons.mode.mode_haiku',
    'nodejax.examples.comparisons.mode.mode_torch',
    ...
    'nodejax.examples.comparisons.generics.generics_nodejax',
    'nodejax.examples.comparisons.generics.generics_equinox',
    'nodejax.examples.comparisons.generics.generics_flax',
    'nodejax.examples.comparisons.generics.generics_keras',
    'nodejax.examples.comparisons.generics.generics_torch',
]
